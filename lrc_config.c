...
{0x0, 0x0, 0x0, 0x0, 0x0, 0xff, 0xc0, 0x1, 0x1, 0x1, 0x1, 0x1, 0xc1, 0x2, 0x2, 0x2, 0x2, 0x2, 0xc2, 0xee, 0xff};
...
const int lrc_gs[GLOBAL_S] = {5, 20};
...
const int lrc_offset[SUBSTRIPES + E_BLOCKS + GLOBAL_S] = {5, 6, 12, 18, 19, 20};
