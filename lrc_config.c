...
{0x0, 0x0, 0x0, 0xc1, 0x1, 0x1, 0x1, 0xc0, 0x2, 0x2, 0x2, 0xc2, 0xee, 0xff, 0xff};
...
const int lrc_gs[GLOBAL_S] = {13, 14};
...
const int lrc_offset[SUBSTRIPES + E_BLOCKS + GLOBAL_S] = {3, 7, 11, 12, 13, 14};
