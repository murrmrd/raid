...
{0x0, 0x0, 0x0, 0x0, 0x0, 0xc0, 0x1, 0x1, 0x1, 0x1, 0x1, 0xc1, 0x2, 0x2, 0x2, 0x2, 0x2, 0xc2, 0xee, 0xff};
...
const int lrc_gs[GLOBAL_S] = {19};

// places of all local syndromes
const int lrc_ls[SUBSTRIPES] = {5, 11, 17};
// empty place
const int lrc_eb = 18;
// not-data blocks, ordered by increasing
const int lrc_offset[SUBSTRIPES + E_BLOCKS + GLOBAL_S] = {5, 11, 17, 18, 19};
// number of the last data block
const int lrc_ldb = 16;
